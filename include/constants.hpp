...
// const Point_3 current_foot_pos(0.0, 0.0, 0.0); // starting point for long stairs
...
const std::vector<std::vector<Point_3>> surf_list = {
    ...
    // // 2nd stair
    // {
    //     Point_3(0.425, 0.0, 0.2),   // bottom left
    //     Point_3(0.725, 0.0, 0.2),   // bottom right
    ...
    // // 4th stair
    // {
    //     Point_3(1.03, 0.0, 0.4),    // bottom left
    //     Point_3(1.33, 0.0, 0.4),    // bottom right
